...
<Tabs>
  ...
  <Tab title="Behind a proxy">
    Velocity or BungeeCord already verified the account before the backend saw
    the connection, and forwarded the real profile with it.
  ...
  <Tab title="online-mode: true">
    The server did it. Every connection is premium by definition and nobody is
    ever asked for a password.
  </Tab>
</Tabs>
